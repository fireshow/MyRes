...
public class StudentDAO extends HibernateDaoSupport {
	...
	public static final String SPHON = "sphon";
	public static final String SADRESS = "sadress";
	...
	{
			List<Student> list=this.findBySname(username);
			if(list.size()>0)
			{
				for (Student student : list) {
					if(student.getSpass().equals(passord))
					{
						return true;
					}
				}
	...
	public List<Student> findBySname(Object sname) {
		return findByProperty(SNAME, sname);
	}

	public List<Student> findBySids(Object sids) {
		return findByProperty(SIDS, sids);
	}
	
	public List<Student> findBySsex(Object ssex) {
		return findByProperty(SSEX, ssex);
	}

	public List<Student> findBySpass(Object spass) {
		return findByProperty(SPASS, spass);
	}

	public List<Student> findBySphon(Object sphon) {
		return findByProperty(SPHON, sphon);
	}

	public List<Student> findBySadress(Object sadress) {
		return findByProperty(SADRESS, sadress);
	}
